...
This repository describes the G4 API. The description from the master branch is automatically rendered into [API Documentation](http://docs.g4.apiary.dev).
...
If you want to develop a client for this API, head [to the documentation](http://docs.g4.apiary.dev) to get the address of the mock server (lives on `apiary-mock.com`) generated from this blueprint.
